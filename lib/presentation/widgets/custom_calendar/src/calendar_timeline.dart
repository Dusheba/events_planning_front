            ...
            return Row(
              children: <Widget>[
                DayItem(
                  ...
                  dayColorGradient: currentDay.weekday == 7 ? AppTheme.birthdayGradient : AppTheme.otherGradient,
          ...
          return Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                DayItem(
                  isSelected: _monthSelectedIndex == index,
                  dayNumber: currentDate.month,
                  shortName: monthName.length > 3
                      ? monthName.substring(0, 3)
                      : monthName,
                  onTap: () => _goToActualMonth(index),
                  available: widget.selectableDayPredicate == null
                      ? true
                      : widget.selectableDayPredicate!(currentDate),
                  dayColor: widget.dayColor,
                  activeDayColor: widget.activeDayColor,
                  dayColorGradient: currentDate.weekday == 7 ? AppTheme.birthdayGradient : AppTheme.otherGradient,
                  activeDayBackgroundColor: AppTheme.bottomNavigationPurple,
                  dotsColor: widget.dotsColor,
                  dayNameColor: widget.dayNameColor,
                ),
