...
import 'package:events_planning/presentation/utils/extensions.dart';
...
class DayItem extends StatelessWidget {
  ...
  const DayItem({
    ...
    this.available = true,
    this.dayColorGradient = AppTheme.otherGradient,
    this.dotsColor,
    this.dayNameColor,
  }) : super(key: key);
  ...
  _buildDay(BuildContext context) {
    final dateStyle = AppTheme.eventHeadline;
    final selectedDateStyle = AppTheme.eventHeadline;

    final dayStyle = AppTheme.eventPanelHeadline;
    final selectedDayStyle = AppTheme.eventHeadline;
