...
// import 'package:events_planning/data/entities/entities.dart';
// import 'package:events_planning/logic/blocs/blocs.dart';
...
import '../widgets/custom_date/date_picker.dart';
import 'utils.dart';
  ...
  static Future<DateTime?> showDeadlineDatePicker(
    ...
    if(Platform.isIOS){
      ...
      final DateTime? picked = await showCustomDatePicker(
        ...
        confirmText: 'Select',
        cancelText: 'Не указывать дату',
        builder: (context, child) {
          return Theme(
            data: ThemeData(fontFamily: 'Gotham').copyWith(
              colorScheme: ColorScheme.light().copyWith(
                primary: AppTheme.purpleBlue,
              ),
  ...
  static void showDeadlineTimePicker(
    ...
    Navigator.of(context).push(
      showPicker(
        ...
        is24HrFormat: true,
        accentColor: AppTheme.purpleBlue,
        unselectedColor: AppTheme.pinkBright,
